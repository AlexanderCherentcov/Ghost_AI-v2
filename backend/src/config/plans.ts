...
export const CASPER_COSTS = {
  ...
  // реальном трафике.
  voice_exchange: 8,
  // 2026-08-30: цена по прямому решению Александра — TTS-режим ("Озвучка") это
  // ровно один шаг из voice_exchange (тот же вызов synthesizeSpeech, тот же лимит
  // текста ≤500 символов), но без STT и без ответа "мозга" — оценивать себестоимость
  // ниже voice_exchange было бы честнее, но Александр явно выбрал ту же цену.
  tts_generate: 8,
} as const;
