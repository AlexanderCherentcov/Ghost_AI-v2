      ...
      >
        <div className="card" style={{ borderRadius: '20px', padding: '32px' }}>
          ...
          <div className="space-y-3 mt-4">
            <Tooltip content={!consented ? 'Подтвердите пользовательское соглашение' : ''} side="top">
              {consented ? (
                <a
                ...
                <button disabled className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-[var(--border)] bg-transparent text-sm text-[rgba(255,255,255,0.2)] cursor-not-allowed">
                  <YandexIcon />
                  Войти через Яндекс
                </button>
              )}
