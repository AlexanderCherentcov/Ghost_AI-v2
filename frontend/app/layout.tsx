...
export const metadata: Metadata = {
  ...
  // ── Иконки — только через файлы App Router, явного `icons` здесь нет ────
  // app/icon.png — вкладка браузера: логотип со скруглёнными углами (радиус 20%), 128 px, 8 КБ.
  // app/apple-icon.png — квадратная и непрозрачная (180 px): iOS скругляет иконку сама, а прозрачные
  // углы на ней превращаются в чёрные. Раньше здесь были ссылки на квадратный icon-192.png.
