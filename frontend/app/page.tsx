...
const FEATURES = [
  {
    ...
    label: 'Ghost Chat',
    color: '#7B5CF0',
    desc: 'Текстовые диалоги, анализ, код, переводы, суммаризация. Умный роутинг между лучшими моделями.',
  },
  {
    Icon: VisionIcon,
    label: 'Ghost Vision',
    color: '#5C8CF0',
    desc: 'Генерация изображений по текстовому описанию. DALL-E 3 и Stable Diffusion XL.',
  },
  {
    Icon: SoundIcon,
    label: 'Ghost Sound',
    color: '#5CF0C8',
    desc: 'Генерация музыкальных треков по описанию. От джаза до электроники.',
  },
  {
    Icon: ReelIcon,
    label: 'Ghost Reel',
    color: '#F05C8C',
    desc: 'Генерация коротких видеоклипов. Runway Gen-3 под капотом.',
  },
  {
    Icon: ThinkIcon,
    label: 'Ghost Think',
    color: '#F0C85C',
    desc: 'Думающая модель для сложных задач. Рассуждает шаг за шагом.',
  },
];
...
const THESIS = [
  { Icon: SparkleIcon, title: 'Умный роутинг', desc: 'Простые вопросы — дешёвый AI. Сложные задачи — мощные модели. Автоматически.' },
  { Icon: TokenIcon,   title: 'Кэш ответов',   desc: 'Популярные запросы закэшированы. Мгновенные ответы без задержки.' },
  { Icon: GhostIcon,   title: 'GhostLine',      desc: 'Постоянно обновляем модели. Вы всегда используете лучшее из доступного.' },
];
      ...
      <section id="about" className="py-24 px-6 bg-[var(--bg-surface)] border-y border-[var(--border)]">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-medium tracking-tight mb-4">Под капотом GhostLine</h2>
            <p className="text-[rgba(255,255,255,0.45)] max-w-xl mx-auto leading-relaxed">
              GhostLine построен на базе лучших AI-моделей мира и собственных разработок команды.
              Какие именно — наш секрет и конкурентное преимущество.
            </p>
          </motion.div>
