    ...
    <div className="min-h-screen bg-[var(--bg-void)] text-white overflow-x-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 overflow-hidden">
        ...
        >
          ...
          >
            Без карты · 5 сообщений/день · 5 картинок/неделю · 3 видео/неделю бесплатно
          </motion.p>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl px-6 py-4 mb-6">
            <div>
              ...
              <span className="ml-3 text-sm text-[rgba(255,255,255,0.4)]">5 сообщений/день · 5 картинок/неделю · 3 видео/неделю · Без карты</span>
            </div>
