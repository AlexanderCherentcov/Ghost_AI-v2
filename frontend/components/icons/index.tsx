...
export function VisionIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg {...iconProps(size)} className={className}>
...
export function SoundIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg {...iconProps(size)} className={className}>
...
export function ReelIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg {...iconProps(size)} className={className}>
