...
export const api = {
  ...
  generate: {
    ...
    sound: (data: { prompt: string; chatId?: string; musicMode?: 'short' | 'long' | 'quality' | 'suno'; musicDuration?: number; sunoStyle?: string; sunoTitle?: string; sunoInstrumental?: boolean }) =>
