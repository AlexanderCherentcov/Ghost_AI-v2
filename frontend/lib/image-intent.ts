...
export const EDIT_VERBS = [
  ...
  'перекрась', 'раскрась', 'нарисуй', 'стилизуй',
  // "исправь/поправь" — самая естественная формулировка правки ("исправь руки") —
  // раньше отсутствовала здесь, из-за чего такой запрос уходил как генерация
  // НОВОЙ картинки без sourceImageUrl вместо редактирования уже полученной.
